...
SYSTEM_INSTRUCTION = (
    ...
    "- Use agent only when the request needs screen/app inspection, active desktop-task steering, desktop/computer-work interruption, multi-step local work, code edits, debugging, investigation, current web/docs/pricing/news/benchmark research, or Codex reasoning over time.\n"
